...
RSpec.describe "Invite" do
  ...
  before do
    ...
    Models::UsersList.new(user_id: refused_user.id, list_id: list.id, has_accepted: false, permissions: "write")
  ...
  it "removes share" do
    ...
    expect(share_list_page).to have_no_selector("[data-test-id='accepted-user-#{accepted_user.id}']")
    expect(share_list_page).to have_no_selector("[data-test-id='pending-user-#{accepted_user.id}']")
    expect(share_list_page).to have_no_selector("[data-test-id='refused-user-#{accepted_user.id}']")
  end
end
