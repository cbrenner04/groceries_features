...
module Pages
  ...
  module TestSelectors
    def find_by_test_id(test_id, **)
      find("[data-test-id='#{test_id}']", **)
    end

    def find_by_test_class(test_class, **)
      find("[data-test-class='#{test_class}']", **)
    end

    def all_by_test_id(test_id, **)
      all("[data-test-id='#{test_id}']", **)
    end

    def all_by_test_class(test_class, **)
      all("[data-test-class='#{test_class}']", **)
    end
