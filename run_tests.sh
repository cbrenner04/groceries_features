...
bundle exec ruby spec/scripts/sign_in_to_results.rb
# run tests
...
bundle exec ruby spec/scripts/sign_out_of_results.rb
# clean up the database only once, after all tests are finished
bundle exec ruby spec/scripts/clean_database.rb
